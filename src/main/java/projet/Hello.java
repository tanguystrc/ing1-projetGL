...
/**
 * Cette classe représente le point d'entrée principal pour l'application JavaFX.
 * Elle initialise l'interface graphique et fournit diverses fonctionnalités 
 * telles que le chargement d'images, le morphing d'images et la création de GIF.
 * 
 * 
 * Les principales fonctionnalités incluent :
 * - La sélection et l'affichage d'images.
 * - La création et la manipulation de points de contrôle pour le morphing d'images.
 * - Le démarrage du processus de morphing et l'affichage du GIF résultant.
 * - La fourniture de configurations d'exemples pour des tests rapides.
 * - Permettre aux utilisateurs d'ajouter un GIF existant au processus de morphing.
 * 
 */
...
import projet.fx.FormesArrondiesFX;
import projet.fx.FormesFX;
import projet.fx.FormesLineaireFX;
import projet.fx.PhotoFX;
import projet.gif.GIFViewer;
import projet.traitement.Forme;
import projet.traitement.FormeArrondie;
import projet.traitement.Visage;
...
public class Hello extends Application {
    ...
    private void chargerExemple() {
        if (formeActuelle instanceof FormesLineaireFX) {
            imageDebut = rognerImage(new Image("file:./src/main/resources/img/carre.png", 600, 600, true, true));
            imageFin = rognerImage(new Image("file:./src/main/resources/img/triangle.png", 600, 600, true, true));
            ...
            imageDebut = rognerImage(new Image("file:./src/main/resources/img/coeur.png", 600, 600, true, true));
            imageFin = rognerImage(new Image("file:./src/main/resources/img/croissant.png", 600, 600, true, true));
            ...
            imageDebut = rognerImage(new Image("file:./src/main/resources/img/visage1.jpg", 600, 600, true, true));
            imageFin = rognerImage(new Image("file:./src/main/resources/img/visage2.png", 600, 600, true, true));            
            pointsDeControle.getPointsList().clear();

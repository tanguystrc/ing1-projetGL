...
public class Visage {   
     ...
     */
    public Visage(BufferedImage image1, BufferedImage image2, List<PointDeControle> listePoint, int nbFrame) {
    ...
    public void morph(int dureeGIF, BiConsumer<Integer, Integer> progressUpdater) throws IOException {
        ...
        for (int k = 1; k < nbFrame - 1; k++) {
            ...
            final int progression = k + 1;
            Platform.runLater(() -> progressUpdater.accept(progression, this.nbFrame));
        }
